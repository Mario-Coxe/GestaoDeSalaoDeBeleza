...
if (isset($_POST['addProduct'])) {
  ...
  if (empty($_POST["prod_code"]) || empty($_POST["prod_name"]) || empty($_POST['prod_desc']) || empty($_POST['prod_price'])) {
    ...
    if ($postStmt) {
      $success = "Tipo de corte adicioonado" && header("refresh:1; url=add_product.php");
    } else {
      $err = "Desculpa, tente de novo ou depois";
    }
  }
}
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h3>Porfavor Preencha todos os campos</h3>
            </div>
            <div class="card-body">
              <form method="POST" enctype="multipart/form-data">
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <input type="submit" name="addProduct" value="Adicionar Corte" class="btn btn-success" value="">
                  </div>
                </div>
              </form>
            </div>
