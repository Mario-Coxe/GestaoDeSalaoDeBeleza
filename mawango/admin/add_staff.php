<?php
session_start();
include('config/config.php'); //BD
include('config/checklogin.php'); //Ver se o usuario esta logado
...
if (isset($_POST['add_staff'])) {
  ...
  if (empty($_POST["staff_number"]) || empty($_POST["staff_name"]) || empty($_POST['staff_email']) || empty($_POST['staff_password'])) {
    ...
    if ($postStmt) {
      $success = "Operador Caixa Adicionado Com Sucesso" && header("refresh:1; url=hrm.php");
    } else {
      $err = "Desculpa! tente Depois";
    }
  }
}
          ...
          <div class="card shadow">
            ...
            <div class="card-body">
              <form method="POST">
                ...
                <div class="form-row">
                  <div class="col-md-6">
                    <input type="submit" name="addStaff" value="Adicionar Operador Caixa" class="btn btn-success" value="">
                  </div>
                </div>
              </form>
            </div>
