        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="change_profile.php">
              <i class="fas fa-users text-primary"></i> Meu Perfil
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="orders.php">
              <i class="ni ni-cart text-primary"></i>Fazer Reserva
            </a>
          </li>
          <li class="nav-item">
        ...
        <ul class="navbar-nav mb-md-3">
          <li class="nav-item">
            <a class="nav-link" href="orders_reports.php">
              <i class="fas fa-shopping-basket"></i> Minhas Compras
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="payments_reports.php">
              <i class="fas fa-funnel-dollar"></i> Meu Pagamentos
            </a>
          </li>
        </ul>
        <hr class="my-3">
