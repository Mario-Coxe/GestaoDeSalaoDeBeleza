...
if (isset($_POST['make'])) {
    ...
    if (empty($_POST["order_code"]) || empty($_POST["customer_name"]) || empty($_GET['prod_price'])) {
        ...
        if ($postStmt) {
            $success = "Compra Submetida" && header("refresh:1; url=payments.php");
        } else {
                ...
                <div class="col">
                    <div class="card shadow">
                        <div class="card-header border-0">
                            <h3>Porfavor Preecha todos os compos</h3>
                        </div>
                        <div class="card-body">
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <input type="submit" name="make" value="Comprar" class="btn btn-success" value="">
                                    </div>
                                </div>
                            </form>
                        </div>
