                ...
                <div id="Receipt" class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
                    <div class="row">
                        <div class="col-xs-6 col-sm-6 col-md-6">
                            <address>
                                <strong>Mawango</strong>
                                <br>
                                'Mawango'
                                <br>
                                 'Sapú 2, Casas Azuis'
                                <br>
                                (+244) 952602436 / 925805753
                            </address>
                        </div>
                        <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                            <p>
                                <em>Data: <?php echo date('d/M/Y g:i', strtotime($order->created_at)); ?></em>
                            </p>
                            <p>
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="col-md-1 text-center"><?php echo $order->prod_price, ' kz'; ?></td>
                                    <td class="col-md-1 text-center"><?php echo $total, ' kz'; ?></td>
                                </tr>
                                <tr>
                                    <td>   </td>
                                    <td>   </td>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center text-danger">
                                        <h5><strong><?php echo $total, ' kz'; ?></strong></h5>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
