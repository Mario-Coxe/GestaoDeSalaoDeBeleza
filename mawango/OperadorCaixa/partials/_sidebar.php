  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <a class="navbar-brand pt-0" href="dashboard.php">
        <img src="../admin/assets/img/brand/logo.jpg" class="navbar-brand-img" alt="..." height="200" width="100">
      </a>
      <!-- User -->
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="payments.php">
              <i class="ni ni-credit-card text-primary"></i> Pagamentos
            </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="receipts.php">
              <i class="fas fa-file-invoice-dollar text-primary"></i> Factura
            </a>
          </li>
        </ul>
        <!-- Divider -->
        ...
        <ul class="navbar-nav mb-md-3">
          ...
          <li class="nav-item">
            <a class="nav-link" href="payments_reports.php">
              <i class="fas fa-funnel-dollar"></i> Pagamentos
            </a>
          </li>
        </ul>
        <hr class="my-3">
