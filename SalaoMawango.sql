...
--
-- Database: `SalaoMawango`
--

-- --------------------------------------------------------

--
-- Estrutura da tabela `rpos_admin`
--
...
--
-- Extraindo dados da tabela `rpos_admin`
--

INSERT INTO `rpos_admin` (`admin_id`, `admin_name`, `admin_email`, `admin_password`) VALUES
('10e0b6dc958adfb5b094d8935a13aeadbe783c25', 'Administraor', 'ruth@mail.com', '10470c3b4b1fed12c3baac014be15fac67c6e815');

-- --------------------------------------------------------

--
-- Estrutura da tabela `rpos_customers`
--
...
--
-- Extraindo dados da tabela `rpos_customers`
--
...
--
-- Estrutura da tabela `rpos_orders`
--
...
--
-- Extraindo dados da tabela `rpos_orders`
--
...
--
-- Estrutura da tabela `rpos_pass_resets`
--
...
--
-- Extraindo dados da tabela `rpos_pass_resets`
--
...
--
-- Estrutura da tabela `rpos_payments`
--
...
--
-- Extraindo dados da tabela `rpos_payments`
--
...
('73d35f', 'LG549PBY86', 'CPAT-2591', '06549ea58afd', '7', 'Paypal', '2023-02-28 17:58:58.658384'),
...
--
-- Estrutura da tabela `rpos_products`
--
...
('8970e6586d', 'ZUDH-9274', 'Bolo', 'turkshcoffee.jpg', 'tttt', '300', '2023-03-17 10:05:26.796722'),
...
('d95c244e2c', 'IMEX-7065', 'saco', '', 'sssssssssssssss', '300', '2023-03-17 10:07:30.200065'),
...
--
-- Estrutura da tabela `rpos_staff`
--
...
--
-- Extraindo dados da tabela `rpos_staff`
--
...
--
-- Limitadores para a tabela `rpos_orders`
--
ALTER TABLE `rpos_orders`
